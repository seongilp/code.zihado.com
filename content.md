...
| 분야 | 프로젝트 수 | 대표작 |
|------|:---:|------|
| 🌐 웹 서비스·대시보드 | 30 | 국회 감시 대시보드, 법령 검색, 실시간 같이보기(Unflix) |
...
### 서울 실시간 혼잡도 지도 · `datalab/seoul-pulse`
...
### 산행 — 전국 등산로 지도 · `datalab/sanhaeng`
산림청 100대명산·국립공원 탐방로 등 전국 등산 공공데이터를 지도 위에서 훑어보는 웹앱.
- 100대명산 607코스, 국립공원 탐방로 1,890구간 등을 난이도·소요시간과 함께 지도에 표시
