...
AI와 짝을 이뤄 만든 50개 프로젝트를 분야별로 모은 **동네 주민 코딩 교육용 포트폴리오** 사이트입니다.
...
목표 설정은 `index.html`의 `GOAL` 상수 한 곳에 있습니다:

```js
const GOAL = {start:'2026-05-26', target:100, months:12};
```

진행률·남은 기간·필요 페이스는 이 값과 카드 수로 자동 계산됩니다.
